...
public class ComponentPanel extends JPanel {
		...
		// LAPTOP
		public ComponentPanel(String GPU[],String CPU[],String RAM[], String currentName, String currentMemory, String currentCpu, String currentType, String currentGpu)
		{
		    Border roundedBorder = new LineBorder(new Color(47, 79, 79), 3, true);
		...
		public ComponentPanel(String CPU[],String RAM[], String currentName, String currentMemory, String currentCpu)
		{
			...
			compList.addListSelectionListener(new ListSelectionListener() {
			    public void valueChanged(ListSelectionEvent event) {
		            ...
		            case 0: populateList(CPU,itemModel,itemList,currentCPU);
		            break;
		            case 1: populateList(RAM,itemModel,itemList,currentRAM);
		            break;
					}				    
				}
			});
		...
		public void populateList(String[] arr, DefaultListModel<String> model, JList<String> list, String currentItem)
		{
			...
			for(int i =0;i<arr.length;i++)
			{
				...
				System.out.println(arr[i] + " ----- " + currentItem);
